...
Total year runtime: 60.18s

The following table has been run as an average of 1 run.

Legend: 🟢 < 1ms, 🟡 < 1s, 🔴 >= 1s

| Day  |   Parse |  Part 1 |  Part 2 |   Total |
| ---- | ------: | ------: | ------: | ------: |
| 01🟢 |    24µs |    12µs |    13µs |    49µs |
| 02🟢 |    10µs |   135µs |   213µs |   358µs |
| 03🟡 | 2.236ms |   172µs |   173µs | 2.581ms |
| 04🟡 |   910µs | 5.566ms | 1.134ms |  7.61ms |
| 05🔴 |     0µs |    6.7s |  17.17s |  23.87s |
| 06🟢 |    23µs |   431µs |   394µs |   848µs |
| 07🟡 | 4.442ms | 9.948ms | 1.171ms | 15.56ms |
| 08🟢 |   256µs |   144µs |   122µs |   522µs |
| 09🟢 |     0µs |   107µs |   640µs |   747µs |
| 10🟡 |  1.13ms |    41µs |    42µs | 1.213ms |
| 11🔴 |    10µs |   149ms |   931ms |   1.08s |
| 12🔴 |    31µs |    50ms |   1.12s |   1.17s |
| 13🟡 |     1µs |   824µs |   293µs | 1.118ms |
| 14🔴 |     0µs |   449ms |  27.27s |  27.72s |
| 15🟡 |    76µs | 7.776ms |    57ms | 64.85ms |
| 16🔴 |     5µs |    34µs |  3.329s |  3.329s |
| 17🟡 |     0µs |    76µs |   163ms | 163.1ms |
| 18🔴 |    24µs |   155µs |  1.107s |  1.108s |
| 19🔴 |     0µs |   490ms |   842ms |  1.332s |
| 20🟢 |   290µs |   252µs |   250µs |   792µs |
| 21🟢 |    48µs |    33µs |    30µs |   111µs |
| 22🟡 | 1.134ms | 5.507ms | 1.175ms | 7.816ms |
| 23🟢 |     8µs |    21µs |    26µs |    55µs |
| 24🟡 |   181µs | 8.832ms | 8.852ms | 17.87ms |
| 25🟡 |    19µs |   287ms |       - |   287ms |
